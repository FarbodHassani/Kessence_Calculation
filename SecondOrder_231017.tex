...
Where;
\be
{\color{red} C^{(2)}_{\Phi \Phi}= a^3 M_*^2 \dot{f}\text{ .}}
\ee
\be
C^{(2)}_{\Phi \Psi}= -a^3 (m_3^3 - M_*^2 \dot{f}) \text{ .}
\ee
\be
C^{(2)}_{\Phi \pi}= a^3 (\dot{m_3^3 } -M_*^2 \ddot{f}  )     \text{ .}
\ee
\be
...
\ee
\be
{\color{red} C^{(2)}_{\Phi  \dot{\pi}}= a^3 m_3^3    \text{ .} }
\ee
\be
C^{(2)}_{\Psi \Phi}= a^3 (2M_*^2 \dot{f})  \text{ .}
\ee
\be
C^{(2)}_{\Psi \Psi}=a^3 (2M_*^2 \dot{f})  \text{ .}
\ee
\be
C^{(2)}_{\Psi \pi}= a^3 (2M_*^2 \ddot{f})   \text{ .}
\ee
\be
...
\ee
\be
C^{(2)}_{\pi \Phi}= a^3 (-3 m_3^3 H +2c -4 M_2^4 + \dot{m_3^3})  \text{ .}
\ee
\be
C^{(2)}_{\pi \Psi}= a^3 ( -m_3^3 H -2c - \dot{m_3^3}) \text{ .}
\ee
\be
C^{(2)}_{\pi \pi}=  a^3 (\dot{m_3^3} H + 2\dot{c} -3 m_3^3 \dot{H} + \ddot{m_3^3} ) \text{ .}
\ee
\be
C^{(2)}_{\pi \dot{\Phi}}=   -a^3 m_3^3     \text{ .}
\ee
\be
C^{(2)}_{\pi  \dot{\Psi}}= -4 a^3 m_3^3   \text{ .}
\ee
\be
 C^{(2)}_{\pi  \dot{\pi}}=4 a^3 M_2^4    \text{ .} 
\ee
\be
...
\ee
\be
{\color{red} C^{1,1}_{\Phi \Phi}=-a^3 M_*^2 \dot{f} \text{ .} }
\ee
\be
C^{1,1}_{\Phi \Psi}= a^3(-m_3^3 +M_*^2\dot{f})\text{ .}
\ee
\be
{\color{red} C^{1,1}_{\Phi \pi}=2 a^3 (c-2M_2^4 -H m_3^3 +\dot{m_3^3})   .   \text{ .}}
\ee
\be
C^{1,1}_{\Psi \pi}=a^3 ( -2c-H m_3^3 +\dot{m_3^3})     \text{ .}
\ee
\be
C^{1,1}_{\Psi \Psi}=3a^3 M_*^2 \dot{f} \text{ .}
\ee
\be
C^{1,1}_{\pi \pi}=\frac{a^3}{2}  \Big (-m_3^3 H^2 -4 m_3^3 \dot{H} +2 \dot{c} +4 \dot{M_2^4} +4 M_2^4 H - \dot{m_3^3} H    \Big ) \text{ .}
\ee

\be
{\color{red}C^{(1)}_{\dot{\Phi}} (\Phi,\Psi,\pi)= 0  }
\ee
\be
C^{(1)}_{\dot{\Psi}} (\Phi,\Psi,\pi)=-4 a m_3^3 \partial_i \pi
\ee
\be
{\color {red}C^{(1)}_{\dot{\pi}} (\Phi,\Psi,\pi)=2 a (4M_2^4 \partial_i \pi - H m_3^3 \partial_i \pi -\dot{m_3^3} \partial_i \pi   + m_3^3 \partial_i \Phi )   }
\ee
\be
C_{\ddot{\Phi}} (\Phi,\Psi,\pi)=0	\text{ .}
\ee
\be
C_{\ddot{\Psi}} (\Phi,\Psi,\pi)= 3 a^5 (m_3^3 - M_*^2 \dot{f}) \text{ .}
\ee
\be
C_{\ddot{\pi}} (\Phi,\Psi,\pi)=  a^3 (-2 a^2 (c+2 m_2^4) + m_3^3 \nabla^2 \pi)	\text{ .}
\ee
