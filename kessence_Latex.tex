...
\be
2 \frac{\Omega'}{\Omega}=- (1+3  w) \mathcal{H}- \frac{2 \mathcal{H}}{\mathcal{H}}
\ee
Also we have the relation for $\bar{P}'_{,X}$ as following,
\be
\frac{\bar{P}'_{,X}}{\bar{P}_{,X}}=\frac{\bar{P}'}{\bar{P}}+\mathcal{H}=-3 \mathcal{H} (1+w)
\ee
So we have,
\begin{align}
-a^2 \bar{P}'  + \bar{P}'_{,X}=& {a^2 \bar{P}} \Big[3 (1+w) \mathcal{H}  + \mathcal{H}    -3 \mathcal{H} (1+w) (1+ \frac{1}{w})  \Big]  \nonumber \\&=
a^2 \frac{-3(1+w)}{w}   \mathcal{H} \bar{P}
\end{align}
...
+
\frac{ a^2\bar{ P}}{w}   \Big[ - 3(1+w) \mathcal{H} \pi- a^2   (1+w)  \delta X_1 
-
 2   w \Psi
 +
 2  (1+w)  {\pi'}
...
\frac{a^2 \bar{ P}}{w} \,\epsilon ^0 
+
\frac{a^2 \bar{ P}}{w}   \Big[ - 3(1+w) \mathcal{H} \pi+  a^2 (1+w) (\frac{1}{c_s^2}- 2)  \delta X_1 
-
 2 w \Psi
 +
 2  (1+w)  {\pi'}
...
+
3 M_{pl}^2  \mathcal{H}^2 \Omega    \Bigg[ - 3(1+w)\mathcal{H} \, \pi+ (1+w) (\frac{1}{c_s^2}- 2)  \Big[ -\Psi+{\pi'}-  \frac{(\vec{\nabla} \pi)^2}{2} \Big ]
-
 2 w \Psi
 +
 2  (1+w)  {\pi'}
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 \\
  &
  =
3 M_{pl}^2  \mathcal{H}^2 \Omega \Bigg[  1 - 3(1+w)\mathcal{H} \, \pi+ \Psi \Big (- (1+w) (\frac{1}{c_s^2}- 2)-2 w  \Big ) + {\pi'} \Big ( (1+w) (\frac{1}{c_s^2}- 2 )+2 (1+w)   \Big)  - \frac{(\vec{\nabla} \pi)^2}{2}  \Big ( (1+w) (\frac{1}{c_s^2}- 2 )  \Big )
 \Bigg]
 %::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
   \nonumber
 \\
  &
  =
3 M_{pl}^2  \mathcal{H}^2 \Omega \Bigg[  1- 3(1+w)\mathcal{H} \pi+ \Psi \Big (2 - \frac{1+w}{c_s^2}  \Big ) + {\pi'} \Big ( \frac{1+w}{c_s^2}   \Big)  - \frac{(\vec{\nabla} \pi)^2}{2}   \Big ( (1+w) (\frac{1}{c_s^2}- 2 )  \Big )
...
+
\Big[ ({\bar{g}_{i j}} \bar{P}' +\cancel{\bar{P}'_{,X}} \partial_{i} (\tau+\pi) \partial_{j}(\tau+\pi))\pi+ \bar{g}_{i j}  \bar{P}_{,X} \delta X_1 
+
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
=3 M_{pl}^2 \mathcal{H}^2 \Omega    \Bigg[w \delta_{ij} - w (\mathcal{H}+3 (1+w)\mathcal{H}) \pi \delta_{ij} 
+
...
%:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
=3 M_{pl}^2 \mathcal{H}^2 \Omega    \Bigg[  w \delta_{ij} - w (1+3 (1+w))\mathcal{H} \pi \delta_{ij} 
-
...
\be
T_{ij}=3 M_{pl}^2 \mathcal{H}^2 \Omega  \Bigg[  w \delta_{ij} -w(1+3 (1+w))\mathcal{H} \pi  \delta_{ij}
-
 2 w \Phi \,  \delta_{ij} - (1+w) \Psi \, \delta_{ij}+  (1+w) {\pi'} \, \delta_{ij} - \frac{1+w}{2 }   (\vec{\nabla} \pi)^2 \, \delta_{ij} +({1+w}  )\partial_{i} \pi \partial_{j} \pi    \Bigg ] 
     + \mathcal {O}(\epsilon^{2}) 
\ee
...
\be
T_{ii}=3 M_{pl}^2 \mathcal{H}^2 \Omega   \Bigg[   w  -w(1+3 (1+w))\mathcal{H}  \pi 
-
...
\;  \; \; \;   \delta \rho^{d}=\frac{3 M_{pl}^2   \mathcal{H}^2\Omega (1+w)}{c_s^2 \, a^2} \Bigg[ -  3 c_s^2  \mathcal{H} \pi- \Psi+   {\pi'}  -  \Big(1-2 c_s^2 \Big) 
 \frac{(\vec{\nabla} \pi)^2}{2}   \Bigg]
\ee 
...
\be
 \delta P ^{d} = \frac{3 M_{pl}^2   \mathcal{H}^2\Omega(1+ w)}{a^2}  \Big [ - \frac{w}{1+w} \mathcal{H} \pi- 3  \mathcal{H} w \pi - \Psi + \pi' +  \frac{(\vec{\nabla} \pi)^2}{2}   \Big], \; \; 
\;  \; \; \; 
\Sigma_{ij}=\frac{3 M_{pl}^2   \mathcal{H}^2\Omega (1+w) \partial_i \pi \partial_j \pi}{a^2}
\ee
It is important to note that,
\be
  \delta P ^{d} -  c_s^2 \delta \rho^{d} =\frac{3 M_{pl}^2   \mathcal{H}^2\Omega (1+w)}{a^2} \Bigg (\Big( - \frac{w}{1+w}+3(c_s^2-w) \Big)\mathcal {H} \pi + (1-c_s^2) (\vec{\nabla} \pi)^2 \Bigg)
\ee
...
\begin{align}
 & \delta^{d} =\frac{\rho^d -\bar{\rho }^d}{\bar{\rho}^d} =  \frac{1+w}{c_s^2} \Bigg[ - 3 \, c_s^2 \mathcal{H} \pi- \Psi+   {\pi'}  -  \Big(1-2 c_s^2 \Big) 
 \frac{(\vec{\nabla} \pi)^2}{2}   \Bigg] 
 \nonumber
   \\ 
   &
 \theta^d=\vec{\nabla} .\vec{u}^d=\delta^{ij} \partial_j u_i ^d=-\frac{3 M_{pl}^2   \mathcal{H}^2\Omega}{a^2} \Big[1+ \pi' +(\frac{1}{c_s^2} -1) \Big(-\Psi +\pi' - \frac{(\vec{\nabla} \pi)^2}{2}  \Big ) \Big ] \ \partial ^2 \pi  
  \nonumber
   \\ 
   &
   \frac{\delta P ^{d} }{ \delta \rho^{d} }=  c_s^2 \Bigg [1 +\frac{ \Big( - \frac{w}{1+w}+3(c_s^2-w) \Big)\mathcal {H} \pi+ (1-c_s^2) (\vec{\nabla} \pi)^2  }{ - 3c_s^2 \mathcal{H} \pi- \Psi+   {\pi'}  -  \Big(1-2 c_s^2 \Big) 
 \frac{(\vec{\nabla} \pi)^2}{2}  }
\Bigg ]
   \nonumber
   \\ 
 ...
 \be \label{Conteqgg}
 \mathcal{H}' + \frac{1+3 w}{2} \mathcal{H}^2 + \frac{\Omega'}{\Omega} \mathcal{H}=0
 \ee
...
\subsection{Mathematica code tests:}
To test mathematica code, we have obtained the Euler and continuity equations eq. \ref{eqEul}.
...
\begin{align}
\rho &=2 (\bar{X}+\delta X)(\bar{P}_{,X} +\bar{P}_{,X} + \bar{P}_{,XX} \delta X)- \bar{P} - \bar{P}_{,X} \delta X  \\
\nonumber &
...
\be
\delta_{newt}=\frac{\rho- \bar{\rho}}{\bar{\rho}}=\frac{1+w}{c_s^2} \Big ( -\Psi+\pi' _{newt}\Big )
\ee
...
\begin{align}
\delta_{Newt}&=\frac{1+w}{c_s^2} \Big ( -\Psi_{newt}+\pi'_{newt} \Big )= \frac{1+w}{c_s^2} \Big ( -\alpha ' - \mathcal{H} \alpha+\pi'_{synch} +\alpha' \Big ) = \frac{1+w}{c_s^2}\Big (- \mathcal{H} \alpha+\pi'_{synch} \Big )
\nonumber \\ 
&
...
So we have,
\be
\delta_{Newt}= \frac{1+w}{c_s^2} \Big ( - \mathcal{H} \alpha+\pi'_{synch}  \Big )
\ee
\be
\delta_{Synch}= -3 (1+w) \mathcal{H} + \frac{1+w}{c_s^2} \Big ( - \mathcal{H} \alpha+\pi'_{synch}  \Big )
\ee
...
\subsection{Comparing the  $\dot{\pi}$ transfer function directly from hi-class and what we get from class indirectly}
...
\be
\pi'_{newt}=\frac{c_s^2}{1+w} \delta_{newt} + \Psi  \; \; \; \text{(class)}
\ee
We assume two different models, one with $w_0=-0.9, c_s^2=1$ and the other with $w_0=-0.9, c_s^2=10^{-4}$ and we compare the results in both gauges. We tried $c_s^2=10^{-8}$ we got bad results, we guess its because the code deals with large numbers!
...
\caption{Density contrast derivative comparison in class and hi-class in Newtonian gauge for $w_0=-0.9, c_s^2=10^{-8}$.}
%\label{plt2}
\end{center}
\end{figure}
...
\ee
\be
\pi'_{New}=\pi'_{Synch} +\alpha'
\ee
\section{Recovering field transfer from $\theta$ transfer function}
\be
\theta _{Sync}=\theta _{Newt} - \alpha k^2
\ee
\be
 \theta^d (k)= k^2 \Big[1+ \pi' +(\frac{1}{c_s^2} -1) \Big(-\Psi +\pi' \Big ) \Big ]  \pi  (k)
\ee
Where we have neglected $ - \frac{(\vec{\nabla} \pi)^2}{2} $ term since in high redshifts is irrelevant.
So we can recover the field transfer function as following from the class
\be
\pi=\frac{1}{k^2} \Big ( 1-  \pi' -(\frac{1}{c_s^2} -1) \Big(-\Psi +\pi' \Big ) \Big )
\ee
and $\pi'$ is defined as,
\be
\pi'=\frac{c_s^2 \delta}{1+w_0} +\Psi
\ee
Now we want to compare the $\pi$ and $\pi'$ indirectly we calculate  from class output with the one we get directly from hi-class EFTcamb. \\
For transforming the $\pi'$ in synchronous to Newtonian, we get $\alpha'$ as following,
\be
