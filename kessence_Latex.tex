...
\be
P\left( \tau+\pi,\overline{X}+ \delta X_1+\delta X_2 \right) =\overline{P}\left( \tau,\overline {X}\right) 
...
+
 ...
 +
  \bar{P}_{,X}  \left ( \partial_{0} \pi \cancel{ \partial_{i} \tau  }
  +
  \partial_{0} \tau \partial_{i} \pi  \right ) 
  +
...
\Big[
 \delta g^{(1)}_{0 i} \bar{P} 
 +
  \bar{P}_{,X}   \partial_{0} \tau \partial_{i} \pi 
  \Big ] \epsilon^1
+ \mathcal {O}(\epsilon^{3/2}) 
\nonumber 
\\ 
&
= 
3 M_{pl}^2 \mathcal{H}^2 \Omega \Big[
...
+
 ...
 +
  ...
  +
   ...
   +
    \bar{P}_{,X}   \partial_{\mu} \pi \partial_{\nu} \pi \Big ] \epsilon^1
+ \mathcal {O}(\epsilon^{3/2}) %\label{eqTmunu}
\end{align}
So $T_{ij}$ is;
\begin{align}
T_{i j} &
...
-
 2 w \Phi \delta_{ij} 
     +
   {(1+w)}  \partial_{i} \pi \partial_{j} \pi \Bigg ] \epsilon^1
+ \mathcal {O}(\epsilon^{3/2}) 
\nonumber \\ & 
%:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
\ee
which there is sum on $\mu$. We use the upper formula to derive the constraint equation in Mathematica.\\
